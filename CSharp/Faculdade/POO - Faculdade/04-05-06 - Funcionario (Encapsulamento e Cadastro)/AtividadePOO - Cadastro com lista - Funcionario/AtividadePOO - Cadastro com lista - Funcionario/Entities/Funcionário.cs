...
namespace Atividade_POO
{
    internal class Funcionário
    {
        ...
        private DateTime _dataNascimento; //private porque eles só podem serem modificados nessa classe funcionario
        ...
        public double SalarioFinal
        {
            ...
            private set { _salarioFinal = value; }
        }
        public string Nome
        {
        ...
        {
            Salariofinal = SalarioLiquido(DescontoMes) + Bonus;
            return Salariofinal;
        }
